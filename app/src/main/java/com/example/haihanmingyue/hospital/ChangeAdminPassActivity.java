...
public class ChangeAdminPassActivity extends AppCompatActivity {
        ...
        xiu_gai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(psw.equals("") || pswagain.equals(""))   {
                    ...
                    Toast.makeText(ChangeAdminPassActivity.this, "不能为空！", Toast.LENGTH_SHORT).show();
                }
                else if (change(psw)){

                    Toast.makeText(ChangeAdminPassActivity.this, "密码无修改！请勿输入旧密码！", Toast.LENGTH_SHORT).show();

                }else if(!change(psw) && !psw.equals(pswagain)) {
                    Toast.makeText(ChangeAdminPassActivity.this, "两次输入密码不相同！", Toast.LENGTH_SHORT).show();

                }else{

                    Toast.makeText(ChangeAdminPassActivity.this, "修改成功！", Toast.LENGTH_SHORT).show();
                    xiugai();
                    Intent intent = new Intent();
                    intent.setClass(com.example.haihanmingyue.hospital.ChangeAdminPassActivity.this, LoginActivity.class);
    ...
    public void xiugai() {
        ...
        db.update("Admin", values, "code=?", new String[]{str});

    }
    public boolean change(String password) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        String sql = "select * from Admin where code="+ str + " and password=?";
