...
public class AdminChangeDoctorMessageActivity extends AppCompatActivity {
    private String str;
    ...
    public void change(){
        ...
        if(Changename.equals("")||Changesex.equals("")||Changetel.equals("")||Changeage.equals("")||Changebir.equals("")||Changzhicheng.equals("")||Changdepart.equals("")){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_change_doctor_message);
        setTitle("修改个人信息");
        ...
        queren.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(AdminChangeDoctorMessageActivity.this)
                        .setTitle("信息修改")
                        .setMessage("是否确认修改?")
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                intent.setClass(AdminChangeDoctorMessageActivity.this,AdminWatchDoctorActivity.class);
        ...
        while(cursor.moveToNext()) {
            ...
            String useid = cursor.getString(cursor.getColumnIndex("usingid"));
...
//
            ...
            TextView usingid = (TextView) findViewById(R.id.sybf);//用TextView显示值
            usingid.setText(useid);
        }
        cursor.close();
    }
}
